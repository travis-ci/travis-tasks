      ...
      module Mailer
        module Helpers
          ...
          def branch_url(repo, branch)
            Travis.logger.info('Travis::Addons::Email::Mailer::Helpers.branch_url: #{repo} #{branch}')
            ...
            Travis.logger.info('Travis::Addons::Email::Mailer::Helpers.branch_url result: #{result}')
