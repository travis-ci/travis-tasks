...
describe Travis::Addons::Intercom::Task do
  ...
  before do
    ...
    stub_request(:post, "https://api.intercom.io/users").
      with(
        body: "{\"custom_attributes\":{\"test\":\"1\",\"current_plan\":\"pro_tier_plan\",\"public_credits_remaining\":40000,\"private_credits_remaining\":500000,\"last_build_triggered\":\"#{last_build_triggered}\",\"is_on_new_plan\":true,\"renewal_date\":\"#{renewal_date}\",\"has_paid_plan\":true,\"orgs_admin_amount\":1,\"orgs_with_paid_plan_amount\":1},\"id\":\"1\",\"email\":\"test@test.com\",\"user_id\":\"1\"}",
        headers: {
          'Accept'=>'application/vnd.intercom.3+json',
          'Accept-Encoding'=>'gzip, deflate',
          'Acceptencoding'=>'gzip, deflate',
